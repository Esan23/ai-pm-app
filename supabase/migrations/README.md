...
Notes:
- `0001_workspaces.sql` predates the timestamped convention; it corresponds to the applied migration `20260620045105_create_workspaces_table`. That table was superseded by the normalized schema in Phase 0 and **dropped** by `20260913T0002_drop_legacy_workspaces.sql`; both files are kept because this directory is a history, not a desired end state.
